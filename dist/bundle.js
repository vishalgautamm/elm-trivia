...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__elm_Main_elm__ = __webpack_require__(1);
...
const app = __WEBPACK_IMPORTED_MODULE_0__elm_Main_elm__["Main"].embed(node)
...
var _user$project$Util$appendIf = F3(
	function (flag, value, list) {
		return flag ? A2(
			_elm_lang$core$Basics_ops['++'],
			list,
			{
...
var _user$project$View_Header$viewHeader = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Elm Trivia'),
		_1: {ctor: '[]'}
	});

var _user$project$View_Button$btn = F2(
	function (msg, txt) {
		return A2(
...
var _user$project$View_Form$group = function (children) {
	return A2(
...
var _user$project$Request_Helpers$queryString = function (list) {
	return A2(
		F2(
			function (x, y) {
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"ChangeDifficulty":["Data.Difficulty.Difficulty"],"Start":[],"GetQuestions":["Result.Result Http.Error Request.TriviaQuestions.TriviaResults"],"Answer":["Int","String"],"UpdateAmount":["String"],"SubmitAnswers":[],"SavedGameResults":["List Main.GameResults"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Data.Difficulty.Difficulty":{"args":[],"tags":{"Medium":[],"Easy":[],"Hard":[],"Any":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Data.Question.Question":{"args":[],"type":"{ userAnswer : Maybe.Maybe String , question : String , correct : String , incorrect : List String }"},"Main.GameResults":{"args":[],"type":"{ score : Int, total : Int, percent : Float }"},"Request.TriviaQuestions.TriviaResults":{"args":[],"type":"{ code : Int, questions : List Data.Question.Question }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
